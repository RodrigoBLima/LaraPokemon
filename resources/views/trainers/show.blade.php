...
@section('content')
    ...
    <img style="heigth:200px; width:200px; backfround-color:EFEFEF; margin:28px;" class="card-img-top rounded-circle mx-auto d-block " src="/images/{{ $trainer->avatar }}" alt="">
